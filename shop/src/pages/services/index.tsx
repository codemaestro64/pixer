...
function Services() {
  ...
  const [params, setParams] = useState<GigQueryOptions>({
    page: 1,
    limit: 30,
  });

  const { mutate: mutateService, isLoading } = useMutation(client.gigs.all, {
    onSuccess: (res) => {
...
ServicesPage.authorization = true;
