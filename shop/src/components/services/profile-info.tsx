...
function Profile() {
  return (
    <div className='flex items-center'>
      <div className='relative mr-[9.44px] xl:mr-[15px]'>
      ...
      <div>
        <div className='text-[13.84px] xl:text-[22px] text-dark-300 dark:text-white font-poppins font-medium'>
          Jenny Wills
        </div>
...
function Separator({ hideOnXl = false }) {
  return (
    <div className={`w-[1px] self-stretch bg-[#EBEBEB] dark:bg-[#343434] ${
      hideOnXl ? 'xl:hidden' : ''
    }`}></div>
  )
}
