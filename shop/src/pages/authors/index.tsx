...
function Shops() {
  ...
  return (
    <>
      <div className="flex flex-col px-[16px] pb-[35px] 2xl:pb-[58px] md:pt-[24px] 2xl:pt-[38px] md:flex-row md:items-center">
        <div className='mt-[32px] md:mt-0 px-[24px]'>
          <div className='relative'>
            <input
              ...
              autoFocus={true}
              placeholder="Search"
              className="peer text-dark-300 dark:text-white h-[48px] 2xl:h-[62px] w-full 2xl:w-[343px] pl-[70px] pr-[16px] text-[14px] xl:text-[16px] bg-white dark:bg-dark-100 border border-[#bababa] dark:border-[#434343] font-poppins font-semibold rounded-[100px] placeholder-dark-850 dark:placeholder-[#434343] bg-transparent"
            />
        ...
        <div className='mt-[20px] md:mt-0 px-[24px] md:ml-auto'>
