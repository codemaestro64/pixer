...
function TopAndLatestProductsButton({ label, active = false }: { label: string, active?: boolean }) {
  return (
    <button className={`text-[16px] md:text-[23.64px] font-poppins font-medium px-[4px] ${ active ? 'text-dark-300 dark:text-[#d5d5d5] 2xl:dark:text-white pointer-events-none' : 'text-[#989898] 2xl:hidden' }`}>{ label }</button>
  )
}
    ...
    <>
      ...
      <div className='grid grid-cols-1 2xl:grid-cols-[1fr_586.85px]'>
        <div>
          ...
          <div className='mt-[34px] md:mt-[24px] px-[14px] md:px-[32px] 2xl:px-[34px]'>
            <div className='h-[183.13px] md:h-[309px] 2xl:h-[440px] relative rounded-[5.56px] 2xl:rounded-[10px] overflow-hidden'>
            ...
            <div className='md:grid md:grid-cols-2'>
              <div>
                <div className='mt-[10.94px] md:mt-[13px] 2xl:mt-[15px]'>
                  <h1 className='text-[18px] md:text-[22px] 2xl:text-[32px] md:w-[334px] 2xl:w-[400px] 3xl:w-[544px] text-[#3a3a3a] dark:text-[#dedede] font-semibold font-poppins truncate-text-line-two'>Reactify Ecommerce Theme with Dashboard</h1>
                </div>
                <div className='mt-[10.56px] md:mt-[18.75px] 2xl:mt-[28px]'>
                  <Publisher name='Qubitron Solutions' followers={20} logo={PublisherLogo} />
                </div>
              </div>
              <div className='mt-[20px] md:mt-[32.8px] 2xl:mt-[46px] px-[4px] md:px-0 flex items-center md:flex-col'>
                <ContentSocial />
                <div className='relative ml-auto flex md:mt-[35.2px] 2xl:mt-[61.79px]'>
                  <div className='2xl:absolute 2xl:right-0 flex'>
                    <ContentInteractions />
                  </div>
                </div>
              </div>
          ...
          <div className='mt-[27.73px] 2xl:mt-[60.5px]'>
            <div className='px-[14px] md:px-[36px] space-x-[22px] 2xl:flex 2xl:justify-between'>
            ...
            <div className='px-[10px] md:px-[24px] 2xl:px-[29px] pb-[16px] md:pb-[24px] space-y-[8px] md:space-y-[18px] mt-[15px] md:mt-[28px] 2xl:mt-[25.5px]'>
        ...
        <div className='hidden 2xl:block mt-[24px] pr-[25.85px]'>
          <div>
            <ContentTags />
          </div>
          <div className='mt-[25.65px]'>
            <div className='hidden 2xl:flex justify-between items-center px-[20px] py-[14px]'>
